...
//mongodb://harish:entertrack@ds027835.mongolab.com:27835/entertrack

var agenda = require('agenda')({ db: { address: 'localhost/entertrack' } });
...
app.post('/auth/facebook', function(req, res, next) {
  ...
  var appSecret = 'e7c6da343b2b6b1b6c5d9c4f26a57e03';
...
app.post('/api/subscribe', ensureAuthenticated, function(req, res, next) {
  Movie.findById(req.body.showId, function(err, show) {
    if (err) return next(err);
